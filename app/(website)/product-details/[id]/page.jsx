          ...
          <div className="space-y-6">
            <div>
              ...
              <div className="mb-6">
                ...
                <Badge
                  variant="secondary"
                  className="bg-amber-100 text-amber-900 text-xs sm:text-sm"
                >
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                <Button
                  className="bg-[#8a6a3d] w-full h-10 sm:h-11 hover:bg-[#755933] text-white rounded text-sm sm:text-base"
                  onClick={handlePurchase}
                >
                  Purchase
                </Button>
                <Button
                  className="h-10 sm:h-11 w-full sm:w-auto rounded bg-transparent border border-[#00000033] text-[#8a6a3d] hover:bg-transparent text-sm sm:text-base"
                ...
                <button
                  ...
                  className={`px-4 sm:px-6 py-2 sm:py-3 text-sm sm:text-base font-medium flex-shrink-0 ${
                    activeTab === "description"
                      ? "text-[#8a6a3d] border-b-2 border-[#8a6a3d]"
                      : "text-gray-600"
                  }`}
                >
                  Description
                    ...
                    <div>
                      ...
                      >
                        <DialogTrigger asChild>
                          <Button
                            size="sm"
                            className="bg-[#8a6a3d] h-10 sm:h-11 rounded text-white hover:bg-[#755933] mt-6 sm:mt-8 text-sm sm:text-base"
                          >
                            Write a Review
                          </Button>
                        </DialogTrigger>
                        <DialogContent className="sm:max-w-md">
                          ...
                          <div className="space-y-6">
                            ...
                            <Button
                              ...
                              className="w-full bg-[#8a6a3d] hover:bg-[#755933] text-white h-10 sm:h-11 rounded text-sm sm:text-base"
