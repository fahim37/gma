...
export default function BlogDetails() {
  ...
  async function fetchBlogData(blogId: string): Promise<BlogData> {
    ...
    const url = `${process.env.NEXT_PUBLIC_API_URL}/admin/blog/${blogId}`;
    ...
    return (
      <div className="flex flex-col mt-16 sm:mt-20 md:mt-24 lg:mt-[100px]">
        <main className="flex-1 flex flex-col">
          ...
          <Link
            href="/blog"
            className="inline-flex items-center text-[#8a6a3d] hover:underline font-medium mt-4"
          >
            {"<"} Back to Blog
          </Link>
        </main>
  ...
  return (
    <div className="container mx-auto px-2 lg:px-0">
      <div className="flex flex-col mt-16 sm:mt-20 md:mt-24 lg:mt-[100px]">
        <main className="flex-1 flex flex-col">
          <div className="">
            <span className="text-sm sm:text-base font-medium text-[#8a6a3d]">
              {formatDate(blog.createdAt)}
            </span>
            <span className="mx-1 sm:mx-2 text-sm sm:text-base font-medium text-[#8a6a3d]">
              |
            </span>
            <span className="text-sm sm:text-base font-medium text-[#8a6a3d]">
              Blog Post
          ...
          <div className="">
            ...
            <div className="mt-8 pt-6 border-t pb-10">
              <Link
                href="/blog"
                className="inline-flex items-center text-[#8a6a3d] hover:underline font-medium"
              >
                {"<"} Back to Blog
              </Link>
            </div>
