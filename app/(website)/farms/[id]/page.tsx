              ...
              <div className="flex-1">
                ...
                {farm.isOrganic && (
                  <div className="flex items-center gap-2 mb-2">
                    <Clock6 className="w-4 h-4 text-[#8a6a3d] flex-shrink-0" />
                    <span className="text-sm sm:text-base text-[#8a6a3d]">
                      Organic Products
                    </span>
                  </div>
                )}
                <div className="flex items-center gap-1 text-gray-600">
                  <MapPin className="w-4 h-4 text-[#8a6a3d] flex-shrink-0" />
            ...
            <div className="mt-4 sm:mt-6">
              ...
              <div className="mt-4 flex flex-col sm:flex-row gap-3">
                <Button
                  ...
                  disabled={loading}
                  className="bg-[#8a6a3d] hover:bg-[#755933] text-white rounded-md w-full sm:w-auto text-sm sm:text-base px-4 py-2"
                >
                ...
                <Button
                  ...
                  disabled={loading}
                  className="border border-[#8a6a3d] bg-transparent text-[#8a6a3d] hover:bg-[#f6efe4] rounded-md w-full sm:w-auto text-sm sm:text-base px-4 py-2"
                >
          ...
          <DialogContent className="max-w-[90vw] sm:max-w-md">
            ...
            <DialogFooter className="mt-4 flex flex-col sm:flex-row gap-2">
              ...
              <Button
                ...
                className="bg-[#8a6a3d] hover:bg-[#755933] w-full sm:w-auto text-sm sm:text-base"
              >
