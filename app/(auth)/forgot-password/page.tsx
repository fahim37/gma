    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative">
        ...
        <div className="container relative z-10 flex flex-col justify-center items-center p-12 text-white">
          ...
          <h1 className="text-4xl font-bold mb-4">Reset your Table Fresh access</h1>
          <p className="text-lg opacity-90">
            We&apos;ll help you get back to your account in a few quick steps.
          </p>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
        <div className="w-full max-w-md space-y-8">
          <div className="text-center">
            ...
            <p className="mt-2 text-gray-600">Enter your email and we&apos;ll send a one-time code.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <Button type="submit" className="w-full bg-[#8a6a3d] hover:bg-[#755933]" disabled={isLoading}>
              {isLoading ? "Sending OTP..." : "Send OTP"}
            </Button>

            <div className="text-center text-sm">
              <Link href="/login" className="text-[#8a6a3d] hover:text-[#755933]">
                Back to login
              </Link>
            </div>
          </form>
