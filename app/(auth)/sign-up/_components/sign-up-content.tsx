    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative">
        ...
        <div className="container relative z-10 flex flex-col justify-center items-center p-12 text-white">
          ...
          <h1 className="text-4xl font-bold mb-4">Create your Table Fresh account</h1>
          <p className="text-lg opacity-90">
            Join a marketplace built around direct connections and seasonal food.
          </p>
        </div>
      </div>
        ...
        <div className="w-full max-w-md space-y-8">
          <div className="text-center">
            ...
            <p className="mt-2 text-gray-600">
              Get started and begin {userType === "buyer" ? "buying" : "selling"}{" "}
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center space-x-2">
              ...
              <Label htmlFor="terms" className="text-sm">
                ...
                <Link
                  href="/terms"
                  className="text-[#8a6a3d] hover:text-[#755933]"
                >
                  Terms & Conditions
                </Link>
              </Label>
            ...
            <Button
              type="submit"
              className="w-full bg-[#8a6a3d] hover:bg-[#755933]"
              disabled={isLoading}
            >
              {isLoading
                ? "Creating Account..."
            ...
            <div className="text-center text-lg">
              ...
              <Link
                href="/login"
                className="text-[#8a6a3d] hover:text-[#755933] font-medium cursor-pointer"
              >
                Sign in
              </Link>
            </div>
