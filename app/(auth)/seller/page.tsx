    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-[#8a6a3d] mx-auto mb-4"></div>
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div className="space-y-2">
                ...
                <div className="flex justify-center">
                  <Button
                    type="button"
                    className="w-[146px] h-[44px] bg-[#8a6a3d] text-white hover:bg-[#755933]"
                    onClick={() => {
                      setIsMapOpen(true);
              ...
              <div className="flex justify-center">
                <Button
                  type="submit"
                  className="w-[146px] h-[44px] bg-[#8a6a3d] hover:bg-[#755933]"
                  disabled={isLoading}
                >
