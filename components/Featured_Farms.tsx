            ...
            >
              <Popup>
                <div className="p-2">
                  ...
                  {farm.isOrganic && <Badge className="mt-1 text-xs bg-amber-100 text-amber-900">Organic</Badge>}
                </div>
              </Popup>
            </CircleMarker>
...
const Featured_Farms = () => {
    ...
    return (
      <section className="container mx-auto px-4 md:px-0 py-12 mt-[100px]">
        <h2 className="text-3xl text-[#272727] font-semibold mb-8">
          {isCategoryView ? "Loading seasonal picks..." : "Farm highlights"}
        </h2>
        <div
          className={`grid ${
            isCategoryView
  ...
  if (currentError) {
    return (
      <section className="container mx-auto px-4 md:px-0 py-12 mt-[100px]">
        <h2 className="text-3xl text-[#272727] font-semibold mb-8">
          {isCategoryView ? "Category selections" : "Farm highlights"}
        </h2>
        <div className="text-center py-12">
          <p className="text-lg">{currentError instanceof Error ? currentError.message : "Unable to load listings right now."}</p>
        </div>
      </section>
    )
  }
  ...
  return (
    <section className="container mx-auto px-4 md:px-2 py-12 mt-[40px] md:mt-[100px]">
      <div>
        <h2 className="text-3xl text-[#272727] font-semibold mb-8">
          {isCategoryView ? "Category selections" : "Farm highlights"}
          {searchTerm && <span className="text-lg text-gray-600 ml-2">- Matches for &ldquo;{searchTerm}&rdquo;</span>}
        </h2>
            ...
            {products.length > 0 ? (
              products.map((product) => (
                <Link key={product._id} href={`/product-details/${product._id}`} className="group">
                  ...
                  <div className="pt-3">
                    ...
                    <p className="text-xs sm:text-sm text-[#4B5563] mb-2">{"Seasonal availability may vary"}</p>
              ...
              <div className="col-span-full text-center py-12">
                <p className="text-gray-600 text-lg">
                  {searchTerm ? "No matching products found." : "No products are listed in this category yet."}
                </p>
              </div>
            )}
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {farms.length > 0 ? (
                  ...
                  <div className="col-span-full text-center py-12">
                    <p className="text-gray-600 text-lg">
                      {searchTerm ? "No matching farms found." : "No farms are available right now."}
                    </p>
                  </div>
                )}
              </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-1">
                    <Button
                      ...
                      className="h-8 w-8 p-0 border border-[#8a6a3d] text-[#8a6a3d]"
                    >
                        ...
                        {page === "..." ? (
                          ...
                          <Button
                            ...
                            className={`h-8 w-8 p-0 ${
                              currentPage === page
                                ? "bg-[#8a6a3d] hover:bg-[#755933] text-white"
                                : "hover:bg-[#f6efe4] border border-[#8a6a3d] text-[#8a6a3d]"
                            }`}
                          >
                            {page}
                          </Button>
            ...
            <div className="lg:sticky lg:top-4">
              <div className="bg-white rounded-lg shadow-lg overflow-hidden" style={{ height: "600px" }}>
                <div className="p-4 bg-[#fff8ef] border-b border-[#eadfce]">
                  <h3 className="text-lg font-semibold text-[#4f3b24]">Grower locations</h3>
                  <p className="text-sm text-gray-600">
                    {farms.filter((f) => f.longitude && f.latitude).length} farms with mapped coordinates
                  </p>
                </div>
