  ...
  return (
    <div className="w-full relative">
      <Button
        ...
        disabled={loading}
        className="bg-[#fff8ef] border border-[#eadfce] w-[50px] h-[50px] rounded-full absolute top-4 right-4 flex items-center justify-center shadow-lg cursor-pointer hover:bg-[#f7ebdb] transition-colors z-10"
      >
        <MessageCircle className="!w-8 !h-8 text-[#6f5632]" />
      </Button>
            ...
            <div className="space-y-1 sm:space-y-1.5 md:space-y-2 lg:space-y-1">
              <div className="flex items-center gap-2 sm:gap-2.5 md:gap-3 lg:gap-2">
                <div className="rounded-full overflow-hidden w-[40px] h-[40px] sm:w-[45px] sm:h-[45px] md:w-[55px] md:h-[55px] lg:w-[50px] lg:h-[50px] flex-shrink-0">
                  {shouldShowAvatar ? (
                    <div className="w-full h-full bg-gradient-to-br from-[#8a6a3d] to-[#5f4729] flex items-center justify-center">
              ...
              <div className="mt-2 sm:mt-2.5 md:mt-3">
                <div className="text-sm sm:text-base md:text-lg lg:text-base text-[#8a6a3d] font-medium flex items-center hover:text-[#5f4729] transition-colors">
                  Explore farm -&gt;
                </div>
              </div>
            </div>
