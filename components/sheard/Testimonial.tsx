        ...
        >
          <div className="flex items-center justify-between pb-4">
            ...
            <div className="flex justify-end gap-2 mt-4">
              <CarouselPrevious className="h-9 w-[76px] rounded-[4px] border border-[#8a6a3d] flex items-center justify-center text-[#8a6a3d] static" />
              <CarouselNext className="h-9 w-[76px] rounded-[4px] border border-[#8a6a3d] flex items-center justify-center text-[#8a6a3d] static" />
            </div>
          </div>
